from tkinter import Button, END, Tk, Entry, W, E
import parser
import math
...
# adding buttons for arithmatic operations
...
Button(root, text="x!", command=lambda :fact_operation()).grid(row=3, column=5)
